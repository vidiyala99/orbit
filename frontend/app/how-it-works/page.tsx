...
/** OrbitMark - the one recurring shape, echoed here as a faint watermark so
 *  the hero reads as part of the same system as the landing page. */
    ...
    <>
      ...
      <main className="min-h-dvh bg-ground">
        ...
        <section className="relative overflow-hidden px-6 py-12 text-center lg:py-20">
          <OrbitMark className="pointer-events-none absolute left-1/2 top-6 h-48 w-48 -translate-x-1/2 text-accent/[0.07] lg:h-64 lg:w-64" />
          <h1
            style={{ animation: "riseIn 550ms cubic-bezier(0.16,1,0.3,1) 40ms both" }}
            className="font-display relative mx-auto max-w-sm text-fl-hero font-bold leading-tight tracking-[-0.4px] text-ink text-balance sm:max-w-xl lg:max-w-2xl"
          >
        ...
        <section className="bg-ink px-6 py-14 text-center lg:py-24">
          <Reveal>
            <h2 className="font-display text-fl-2xl font-bold tracking-[-0.3px] text-ground">Try it at your next event</h2>
