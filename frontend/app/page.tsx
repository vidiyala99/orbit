...
const EVENTS = ["NERDCONF SF", "Blinkko Launch Party", "Founders Cowork Wednesdays"];
...
function FeatureCard({ feature }: { feature: (typeof FEATURES)[number] }) {
  ...
  return (
    <div className={`lift rounded-card p-6 ${look}`}>
      <p className="font-display text-fl-lg font-bold tracking-[-0.2px]">{feature.title}</p>
...
export default function Page() {
  return (
    <main className="min-h-dvh bg-ground text-ink">
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 pt-12 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.18fr)] lg:gap-14 lg:px-8 lg:pt-16">
        <div className="max-w-[540px]">
          ...
          >
            <Link
              href={APP_HOME}
              className="lift btn-press inline-flex min-h-11 items-center justify-center rounded-full bg-accent px-6 text-fl-base font-bold text-white shadow-glow hover:bg-accent/90 hover:shadow-glow-hover"
            >
              Try it
            </Link>
          </div>
        ...
        <figure
          ...
          className="min-w-0"
        >
          <div data-testid="needs-you-desk" className="relative overflow-hidden rounded-hero bg-accent-soft px-5 py-6 shadow-glow sm:px-7 sm:py-7">
      ...
      <section className="relative overflow-hidden border-t border-rule">
        ...
        <div className="absolute inset-0 flex items-center">
          <Reveal as="div" className="mx-auto max-w-2xl px-6">
            <p className="text-center font-display text-fl-2xl font-medium leading-snug text-ground">
      ...
      <div className="border-t border-rule bg-surface">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-8 px-6 py-14 md:flex-row lg:gap-16 lg:py-20">
          ...
          <Reveal delayMs={120} className="max-w-md">
            <p className="font-display text-fl-xl font-semibold tracking-[-0.2px] text-ink">Connect the guest list</p>
        ...
        <div className="mx-auto flex max-w-5xl flex-col-reverse items-center gap-8 border-t border-rule px-6 py-14 md:flex-row lg:gap-16 lg:py-20">
          <Reveal delayMs={120} className="max-w-md">
            <p className="font-display text-fl-xl font-semibold tracking-[-0.2px] text-ink">It ranks who needs you first</p>
            <p className="mt-2 text-fl-md font-medium leading-relaxed text-ink2">
      ...
      {/* 6. Founding idea - a margin note in an actual handwriting face,
          the one place on the page that annotation treatment belongs. */}
      <section className="border-t border-rule bg-surface px-6 py-16 text-center lg:py-24">
        <Reveal>
          <p className="mx-auto max-w-3xl font-display text-fl-2xl italic font-medium leading-snug tracking-[-0.2px] text-ink text-balance">
          ...
          <p className="mt-5 text-fl-xs font-bold uppercase tracking-[0.08em] text-ink3">- The founding idea</p>
        </Reveal>
      </section>
      ...
      <section className="border-t border-rule bg-ground px-6 py-12 text-center lg:py-16">
        <Reveal>
          <p className="font-display text-fl-xl font-semibold tracking-[-0.2px] text-ink">
      ...
      <section className="border-t border-rule bg-surface px-6 py-16 lg:py-24">
        <div className="mx-auto max-w-2xl">
          <Reveal>
            <h2 className="font-display text-fl-2xl font-semibold tracking-[-0.3px] text-ink">Questions worth asking</h2>
          </Reveal>
      ...
      <section className="border-t border-rule bg-ink px-5 py-16 text-center lg:py-20">
        <Reveal>
          <h2 className="mx-auto max-w-md font-display text-fl-2xl font-semibold tracking-[-0.3px] text-ground">
