      ...
      <div className="relative w-full max-w-sm overflow-hidden rounded-card bg-surface p-6 shadow-card lg:p-8">
        ...
        {done ? (
          <div role="status" className="relative">
            ...
            <Link href="/sign-in" className="mt-3 inline-block rounded-full text-[12.5px] font-semibold text-accent underline decoration-accent/40 transition-colors hover:text-ink">
              Sign in
            </Link>
          </div>
        ) : (
