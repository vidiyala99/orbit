...
FIXTURE_PEOPLE: list[dict] = [
    {
        ...
        "note": (
            "Met Alex Rivera (Partner, Westbound) in the coat-check line at "
            "Founders Cowork Wednesdays. They just closed Fund III and are writing "
        ...
        "dm": (
            "Alex — great running into you at Founders Cowork Wednesdays. You mentioned "
    ...
    },
    {
        ...
        "email_draft": (
            "Hi Riley — following up from the Sunday coffee line. "
